  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.44\textwidth}
      \IfFileExists{figures/generated/attention.png}{%
        \includegraphics[width=0.98\linewidth]{figures/generated/attention.png}
      }{%
        \centering
        \fcolorbox{coral}{bgcard}{\parbox{0.92\linewidth}{\centering\small Missing image: \texttt{figures/generated/attention.png}}}
      }
    \end{column}
  \end{columns}
