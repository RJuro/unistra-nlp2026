...
\begin{frame}{The Model Zoo}
  ...
  \begin{tabular}{lrlrl}
    ...
    Claude Opus 4.7 & 200K & Coding & \$3.00 & 77\% SWE-bench \\
...
\begin{frame}{The Cost of Intelligence is Collapsing}
  ...
  \begin{tikzpicture}[scale=0.85]
    \begin{axis}[
      ...
      symbolic x coords={GPT-4 (2023), Claude 4.5S, GPT-5.2, DeepSeek R1, GPT-4o Mini, DeepSeek V3.2},
      xtick=data,
      ...
      \addplot[fill=gold, draw=gold] coordinates {(Claude 4.5S,15) (GPT-5.2,14) (DeepSeek R1,2.19) (GPT-4o Mini,0.60) (DeepSeek V3.2,0.42)};
    \end{axis}
...
\begin{frame}{Context Windows in 2026}
  ...
  \begin{tikzpicture}[scale=0.85]
    ...
    \end{axis}
    \node[font=\tiny, text=textmuted] at (2.3,0.4) {Log scale reveals both mainstream (0.2--2M) and frontier (10M) ranges.};
  \end{tikzpicture}
  \end{center}
\end{frame}
